  ...
  <div class="bg-white">
    ...
    >
      ...
      <div class="w-full flex flex-col gap-6">
        ...
        <div
          v-else
          class="w-full gap-2 flex flex-col items-center justify-center py-8 bg-gray-100 rounded-lg shadow-md"
        >
          <div class="flex items-center gap-2 text-gray-500">
            <font-awesome-icon
              ...
              class="text-3xl"
            />
            <span class="text-lg font-semibold">No Tasks Available</span>
          </div>
